...
const PALETTE: Record<string, [string, string]> = {
  ...
  GECKO: ['#9fe0d2', '#1f7a6b'],
  HAMSTER: ['#f7df9b', '#b8871b'],
  GUINEA_PIG: ['#f0c0a8', '#9e5238'],
  OTHER: ['#dcd6cb', '#8a7f70'],
}
...
async function main() {
  ...
  const seedPosts = [
    ...
    },
    {
      author: giulia,
      kind: 'LOST',
      title: 'Scappato Pepe, geco leopardino, zona Testaccio',
      species: 'GECKO',
      petName: 'Pepe',
      ageRange: 'ADULTO',
      size: 'PICCOLA',
      color: 'Giallo con macchie scure, circa 20 cm con la coda',
      description:
        'Pepe e uscito dal terrario mentre pulivo il vetro. Si muove lentamente e cerca sempre i posti caldi, quindi non dovrebbe essersi allontanato molto.',
      extraNotes:
        'Controllate dietro i termosifoni, sotto i mobili e vicino alle prese: cerca il tepore. Non prendetelo per la coda, si stacca: meglio appoggiargli sopra una scatola e chiamarmi.',
      address: 'Via Marmorata, Testaccio',
      city: 'Roma',
      province: 'RM',
      lat: 41.8781,
      lng: 12.4753,
    ...
    },
    {
      author: sara,
      kind: 'FOUND',
      title: 'Trovato criceto dorato in un cortile condominiale',
      species: 'HAMSTER',
      ageRange: 'ADULTO',
      size: 'PICCOLA',
      color: 'Dorato con la pancia bianca',
      description:
        'Girava tra le foglie vicino ai bidoni, spaventato e infreddolito. Per ora l ho messo in una gabbia con acqua e semi: sta bene, ma e magro.',
      extraNotes:
        'Probabilmente era fuori da qualche giorno. Cerco chi l ha perso prima di trovargli una casa nuova.',
      address: 'Via Ostiense, cortile interno',
      city: 'Roma',
      province: 'RM',
      lat: 41.8712,
      lng: 12.4801,
      eventDate: daysAgo(1),
      createdAt: daysAgo(1),
      caption: 'Criceto trovato',
    },
    {
      author: marco,
      kind: 'ADOPTION',
      title: 'Cannella e Zucchero, porcellini d India, cercano casa insieme',
      species: 'GUINEA_PIG',
      sex: 'F',
      ageRange: 'ADULTO',
      size: 'PICCOLA',
      color: 'Una fulva, una bianca e nera',
      goodWithKids: true,
      goodWithPets: true,
      description:
        'Due sorelle di un anno e mezzo, socievoli e molto chiacchierone: fischiano appena sentono aprire il frigo. Vanno adottate insieme, si sono sempre fatte compagnia.',
      extraNotes:
        'Servono una gabbia ampia, fieno sempre disponibile e verdura fresca ogni giorno per la vitamina C, che non producono da sole. Consegniamo la gabbia con loro.',
      address: 'Zona Citta Studi',
      city: 'Milano',
      province: 'MI',
      lat: 45.4781,
      lng: 9.2278,
